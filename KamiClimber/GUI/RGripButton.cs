...
{
    class RGripButton : PositionedObject
    {
        ...
        public RGripButton(string contentManagerName)
        {
        ...
        private void CreateVisual()
        {
            ...
            frbButton = SpriteManager.AddSprite("Content/rgripup.png");
        ...
        private void SetVisualDown()
        {
            ...
            frbButton = SpriteManager.AddSprite("Content/rgripdown.png");
            frbButton.Position = this.Position;
            frbButton.ScaleX = 5;
            frbButton.ScaleY = 5;
            frbButton.AttachTo(this, false);
